...
=======
    # BlenderBenchmark().getSettings(command=  '--help')
    BenchmarkFactory(benchmark_name='blender_benchmark',benchmark_settings_file="settings1.json").startBenchmark()
>>>>>>> 058e6cb... Finished interfacing Blender Benchmark
